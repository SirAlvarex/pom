...
// 2019-08-22 19:04:37.0225271 -0700 PDT m=+1.378316201
package pom
...
func (m XMLMap) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	...
	for _, elem := range m.Elements {
		e.Encode(xmlMapEntry{XMLName: xml.Name{Local: elem.XMLName.Local, Space: ""}, Value: elem.Value})
	}
...
type project struct {
	...
	*/
	...
	Reports *XMLMap `xml:"reports,omitempty"`
...
type Notifier struct {
	...
	Configuration *XMLMap `xml:"configuration,omitempty"`
...
type Developer struct {
	...
	Properties *XMLMap `xml:"properties,omitempty"`
...
type Plugin struct {
	...
	Goals *XMLMap `xml:"goals,omitempty"`
