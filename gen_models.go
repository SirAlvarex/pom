...
// 2019-08-23 08:07:59.4324505 -0700 PDT m=+1.496123001
package pom
...
type project struct {
	...
	PluginRepositories struct {
		Comment    string       `xml:",comment"`
		Repository []Repository `xml:"pluginRepository,omitempty"`
...
type Reporting struct {
	...
	Plugins struct {
		Comment      string         `xml:",comment"`
		ReportPlugin []ReportPlugin `xml:"plugin,omitempty"`
...
type BuildBase struct {
	...
	TestResources struct {
		Comment  string     `xml:",comment"`
		Resource []Resource `xml:"testResource,omitempty"`
...
type Plugin struct {
	...
	Executions struct {
		Comment         string            `xml:",comment"`
		PluginExecution []PluginExecution `xml:"execution,omitempty"`
