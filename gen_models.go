// Package pom Code generated DO NOT EDIT
// This file was generated by robots at
// 2019-08-30 10:50:30.772984 -0700 PDT m=+1.548791801
package pom
...
// Workaround to get the project inside a pom to marshal/unmarshel correctly
type project struct {
	Model
}
...
// Model The <code>&lt;project&gt;</code> element is the root of the descriptor.
...
//        fmt.Println(value)
//    }
func (a *Model) GetModelVersion() (returnValue string, exists bool) {
...
// Usage:
// a.SetModelVersion("")
func (a *Model) SetModelVersion(value string) {
	copy := value
	a.ModelVersion = &copy
...
//        fmt.Println(value)
//    }
func (a *Model) GetParent() (returnValue Parent, exists bool) {
	if a.Parent != nil {
...
// Usage:
// a.SetParent(Parent{})
func (a *Model) SetParent(value Parent) {
	copy := value
	a.Parent = &copy
...
//        fmt.Println(value)
//    }
func (a *Model) GetGroupID() (returnValue string, exists bool) {
	if a.GroupID != nil {
...
// Usage:
// a.SetGroupID("")
func (a *Model) SetGroupID(value string) {
	copy := value
	a.GroupID = &copy
...
//        fmt.Println(value)
//    }
func (a *Model) GetArtifactID() (returnValue string, exists bool) {
	if a.ArtifactID != nil {
...
// Usage:
// a.SetArtifactID("")
func (a *Model) SetArtifactID(value string) {
	copy := value
	a.ArtifactID = &copy
...
//        fmt.Println(value)
//    }
func (a *Model) GetVersion() (returnValue string, exists bool) {
	if a.Version != nil {
...
// Usage:
// a.SetVersion("")
func (a *Model) SetVersion(value string) {
	copy := value
	a.Version = &copy
...
//        fmt.Println(value)
//    }
func (a *Model) GetPackaging() (returnValue string, exists bool) {
	if a.Packaging != nil {
...
// Usage:
// a.SetPackaging("")
func (a *Model) SetPackaging(value string) {
	copy := value
	a.Packaging = &copy
...
//        fmt.Println(value)
//    }
func (a *Model) GetName() (returnValue string, exists bool) {
	if a.Name != nil {
		return *a.Name, true
	}
	return "", false
...
// Usage:
// a.SetName("")
func (a *Model) SetName(value string) {
	copy := value
	a.Name = &copy
...
//        fmt.Println(value)
//    }
func (a *Model) GetDescription() (returnValue string, exists bool) {
...
// Usage:
// a.SetDescription("")
func (a *Model) SetDescription(value string) {
	copy := value
	a.Description = &copy
...
//        fmt.Println(value)
//    }
func (a *Model) GetURL() (returnValue string, exists bool) {
	if a.URL != nil {
		return *a.URL, true
	}
	return "", false
...
// Usage:
// a.SetURL("")
func (a *Model) SetURL(value string) {
	copy := value
	a.URL = &copy
...
//        fmt.Println(value)
//    }
func (a *Model) GetInceptionYear() (returnValue string, exists bool) {
...
// Usage:
// a.SetInceptionYear("")
func (a *Model) SetInceptionYear(value string) {
	copy := value
...
//        fmt.Println(value)
//    }
func (a *Model) GetOrganization() (returnValue Organization, exists bool) {
...
func (a *Model) SetOrganization(value Organization) {
	copy := value
	a.Organization = &copy
...
//        fmt.Println(value)
//    }
func (a *Model) GetLicenses() (returnValue SequenceLicense, exists bool) {
	if a.Licenses != nil {
...
func (a *Model) SetLicenses(value SequenceLicense) {
	copy := value
	a.Licenses = &copy
...
//        fmt.Println(value)
//    }
func (a *Model) GetDevelopers() (returnValue SequenceDeveloper, exists bool) {
	if a.Developers != nil {
...
func (a *Model) SetDevelopers(value SequenceDeveloper) {
	copy := value
	a.Developers = &copy
...
//        fmt.Println(value)
//    }
func (a *Model) GetContributors() (returnValue SequenceContributor, exists bool) {
...
func (a *Model) SetContributors(value SequenceContributor) {
	copy := value
	a.Contributors = &copy
...
//        fmt.Println(value)
//    }
func (a *Model) GetMailingLists() (returnValue SequenceMailingList, exists bool) {
...
func (a *Model) SetMailingLists(value SequenceMailingList) {
	copy := value
	a.MailingLists = &copy
...
//        fmt.Println(value)
//    }
func (a *Model) GetPrerequisites() (returnValue Prerequisites, exists bool) {
...
func (a *Model) SetPrerequisites(value Prerequisites) {
	copy := value
...
//        fmt.Println(value)
//    }
func (a *Model) GetModules() (returnValue SequenceModule, exists bool) {
	if a.Modules != nil {
...
func (a *Model) SetModules(value SequenceModule) {
	copy := value
	a.Modules = &copy
...
//        fmt.Println(value)
//    }
func (a *Model) GetScm() (returnValue Scm, exists bool) {
	if a.Scm != nil {
		return *a.Scm, true
	}
	return Scm{}, false
...
//        fmt.Println(value)
//    }
func (a *Model) GetIssueManagement() (returnValue IssueManagement, exists bool) {
...
func (a *Model) SetIssueManagement(value IssueManagement) {
	copy := value
...
//        fmt.Println(value)
//    }
func (a *Model) GetCiManagement() (returnValue CiManagement, exists bool) {
...
func (a *Model) SetCiManagement(value CiManagement) {
	copy := value
	a.CiManagement = &copy
...
//        fmt.Println(value)
//    }
func (a *Model) GetDistributionManagement() (returnValue DistributionManagement, exists bool) {
...
func (a *Model) SetDistributionManagement(value DistributionManagement) {
	copy := value
...
//        fmt.Println(value)
//    }
func (a *Model) GetProperties() (returnValue XMLProperties, exists bool) {
	if a.Properties != nil {
...
func (a *Model) SetProperties(value XMLProperties) {
	copy := value
	a.Properties = &copy
...
//        fmt.Println(value)
//    }
func (a *Model) GetDependencyManagement() (returnValue DependencyManagement, exists bool) {
...
func (a *Model) SetDependencyManagement(value DependencyManagement) {
	copy := value
...
//        fmt.Println(value)
//    }
func (a *Model) GetDependencies() (returnValue SequenceDependency, exists bool) {
...
func (a *Model) SetDependencies(value SequenceDependency) {
	copy := value
	a.Dependencies = &copy
...
//        fmt.Println(value)
//    }
func (a *Model) GetRepositories() (returnValue SequenceRepository, exists bool) {
...
func (a *Model) SetRepositories(value SequenceRepository) {
	copy := value
	a.Repositories = &copy
...
//        fmt.Println(value)
//    }
func (a *Model) GetPluginRepositories() (returnValue SequencePluginRepository, exists bool) {
...
func (a *Model) SetPluginRepositories(value SequencePluginRepository) {
	copy := value
...
//        fmt.Println(value)
//    }
func (a *Model) GetBuild() (returnValue Build, exists bool) {
	if a.Build != nil {
		return *a.Build, true
	}
	return Build{}, false
...
// Usage:
// a.SetBuild(Build{})
func (a *Model) SetBuild(value Build) {
	copy := value
	a.Build = &copy
...
//        fmt.Println(value)
//    }
func (a *Model) GetReports() (returnValue XMLInner, exists bool) {
	if a.Reports != nil {
...
func (a *Model) SetReports(value XMLInner) {
	copy := value
	a.Reports = &copy
...
//        fmt.Println(value)
//    }
func (a *Model) GetReporting() (returnValue Reporting, exists bool) {
	if a.Reporting != nil {
...
func (a *Model) SetReporting(value Reporting) {
	copy := value
	a.Reporting = &copy
...
//        fmt.Println(value)
//    }
func (a *Model) GetProfiles() (returnValue SequenceProfile, exists bool) {
	if a.Profiles != nil {
...
func (a *Model) SetProfiles(value SequenceProfile) {
	copy := value
	a.Profiles = &copy
...
//        fmt.Println(value)
//    }
func (a *Model) GetComment() (returnValue string, exists bool) {
	return a.Comment, false
}
...
// Usage:
// a.SetComment()
func (a *Model) SetComment(value string) {
	a.Comment = value
